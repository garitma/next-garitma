...
export default function SuscribeBox() {
  ...
  return (
    <Section className="p-1" container="smash" passDiv>
      <div className="py-5">
        <div className="px-1">
        ...
        <div className="px-1">
          <p className="h6 font-bold">
            Suscríbete para recibir mis últimas novedades y poemas directamente
            en tu correo. No envío muchos mensajes, solo cuando tengo algo
            especial que compartir contigo.
          </p>
        </div>
      </div>
    </Section>
