                    ...
                    <div className="block small-12 medium-8">
                        <div className="module-box-detail" style={{ background: `${document.data.color}` }}>
                            <div className="module-title">
                                <h2><Link href="/[uid]" as={document.uid}><a>{RichText.asText(document.data.title)}</a></Link></h2>
                            </div>
                            ...
                            <div className="module-cta">
                                ...
                                <span>|</span>
                                <Link href="/cateogorias/[type]" as={`/categorias/${document.type}`}><a className="button-link">Ver más {document.type}</a></Link>
                            </div>
                        </div>
                    </div>
                    <div className="block small-12 medium-4 module-img-container">
                        <Link href="/[uid]" as={document.uid}><a><img className="responsive-image" src={document.data.featured_img.square.url} alt={document.data.featured_img.alt} /></a></Link>
                    </div>
                </li>
            </ul>
        )
