      ...
      <div className="SubHeader">
        <div className="halo smash">
          ...
          <ul className="nav-list flowx wall-pad">
            ...
            <li onClick={onClose}>
              <Link href="/categorias/[type]" as="/categorias/frases">
                <a className="menu-item">Frases</a>
              </Link>
            </li>
            <li onClick={onClose}>
              <Link href="/categorias/[type]" as="/categorias/comics">
                <a className="menu-item">Cómics</a>
              </Link>
            </li>
            <li onClick={onClose}>
              <Link href="/categorias/[type]" as="/categorias/videos">
                <a className="menu-item">Videos</a>
              </Link>
            </li>
            <li onClick={onClose}>
              <Link href="/categorias/[type]" as="/categorias/descargas">
                <a className="menu-item">Descargas</a>
              </Link>
            </li>
            <li onClick={onClose}>
              <Link href="/categorias/[type]" as="/categorias/podcasts">
