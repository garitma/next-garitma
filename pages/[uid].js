...
export default class Post extends React.Component {
  ...
  renderBody() {
    ...
    if (poems != undefined) {
      return <SingleRead document={poems} />;
    }

    if (comics != undefined) {
      return <SingleRead document={comics} />;
    }

    if (downloads != undefined) {
      return <SingleRead document={downloads} />;
    }

    if (games != undefined) {
      return <SingleRead document={games} />;
    }

    if (podcasts != undefined) {
      return <SingleRead document={podcasts} />;
    }

    if (videos != undefined) {
      return <SingleRead document={videos} />;
    }
  }
